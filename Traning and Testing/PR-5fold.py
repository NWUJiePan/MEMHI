...
while counter0 < 5:
    ...
    RAPName = 'HV_IN16_RealAndPredictionA+B' + str(counter0) + '.csv'
    RAPNameProb = 'HV_IN16_RealAndPredictionProbA+B' + str(counter0) + '.csv'
...
while counter < len(mean_P):
    ...
    PAndR.append(pair)
    counter = counter + 1
storFile(PAndR, 'HV_IN16_RNAInterPAndRA+B.csv')
...
plt.savefig('HV_PR64-5fold.tif', dpi=600)
plt.show()
